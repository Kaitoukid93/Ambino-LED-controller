...
{
   public class DeviceStaticColor : IStaticColor
    {
        ...
        public DeviceStaticColor(DeviceInfoDTO device, ISpotSet spotSet, LightingViewModel viewViewModel, SettingInfoDTO setting)
        {
        ...
        private void RefreshColorState()
        {
            ...
            var shouldBeRunning = deviceInfo.LightingMode == "Sáng màu tĩnh";//UserSettings.TransferActive && UserSettings.SelectedEffect == 2;
        ...
        public void Run(CancellationToken token)//static color creator
        {
            ...
            try
            {
                ...
                while (!token.IsCancellationRequested)
                {
                    ...
                    Color currentStaticColor = (Color)System.Windows.Media.ColorConverter.ConvertFromString(deviceInfo.Staticcolor);
                    var colorOutput = new OpenRGB.NET.Models.Color[numLED];
                    double peekBrightness = 0.0;

                    bool isPreviewRunning = deviceInfo.LightingMode == "Sáng màu tĩnh"; //(SettingsViewModel.IsSettingsWindowOpen && UserSettings.SelectedEffect == 2);
                    ...
                    lock (SpotSet.Lock)
                    {
                        ...
                        if (isPreviewRunning)
                        {
                            ...
                            SettingsViewModel.SpotSet = SpotSet;
                        }
