...
{
   public class DeviceMusic : IMusic
    {
        ...
        public DeviceMusic(DeviceInfoDTO device, ISpotSet spotSet, LightingViewModel viewViewModel, SettingInfoDTO setting)
        {
        ...
        private void PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            ...
            switch (e.PropertyName)
            {
                ...
                case nameof(deviceInfo.MusicMode):
                    RefreshAudioState();
                    break;
                case nameof(deviceInfo.MusicSource):
                    RefreshAudioDevice();
                    break;
            }
        }
        private void RefreshAudioState()
        {
            ...
            var shouldBeRunning = deviceInfo.LightingMode == "Sáng theo nhạc";//UserSettings.TransferActive && UserSettings.SelectedEffect == 3;
            ...
            else if (!isRunning && shouldBeRunning)
            {
                ...
                Init();
                int deviceID = deviceInfo.MusicSource;
...

        {
            ...
            try
            {
                ...
                while (!token.IsCancellationRequested)
                {
                    ...
                    bool isPreviewRunning = deviceInfo.LightingMode == "Sáng theo nhạc";//(SettingsViewModel.IsSettingsWindowOpen && UserSettings.SelectedEffect == 3);
                    //audio capture section//
